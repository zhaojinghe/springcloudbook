...
public class BookProviderController {
	...
	@GetMapping("/pagelist")
	@ResponseBody
	public Map<String, Object> showSortPage(@RequestParam(value = "page", defaultValue = "1") Integer page,
	...
	@ResponseBody
	public Map<String, Object> querybynameauthor(@RequestParam(value = "page", defaultValue = "1") Integer page,
			@RequestParam(value = "size", required = false, defaultValue = "5") Integer size,
	 ...
	 * 500); map.put("info", "系统出错，稍后重试"); return map; }
	 */
