    ...
    <form target="_blank" action="#" id="J_payForm" method="post">
      <div class="section section-order">
        <div class="order-info clearfix">
          ...
          <div class="fr">
            <p class="total"> 应付总额：<span class="money" id="payamount"><em>${order.payAmount }</em>元</span> </p>
        ...
        <div class="order-detail">
          <ul>
            <li class="clearfix">
              ...
              <div class="content"> <span class="order-num" id="ordernumber"> ${order.orderNumber } </span> </div>
            </li>
            <li class="clearfix">
        ...
        <div class="payment-box ">
          ...
          <div class="payment-body">
            <ul class="clearfix payment-list J_paymentList J_linksign-customize">
              ...
              <li class="J_bank">
                <input type="button" name="payOnlineBank" id="alipay" value="alipay"/>
                  <a href="${ctx}/alipay/pay?trade_no=${order.orderNumber }&totalmoney=${order.payAmount }">
                  <img src="//c1.mifile.cn/f/i/15/pay/alipay-0718-1.png" alt="支付宝" style="margin-left: 0;"/></a>
                </li>
              <li class="J_bank">
